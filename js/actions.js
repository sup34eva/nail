...
rotx.onchange = function() {
    world.scenes[world.zone_id].meshTab[index].rotation.x = rotx.value / 100;
};

var roty = document.getElementById('roty');
roty.onchange = function() {
    world.scenes[world.zone_id].meshTab[index].rotation.y = roty.value / 100;
};

var rotz = document.getElementById('rotz');
rotz.onchange = function() {
    world.scenes[world.zone_id].meshTab[index].rotation.z = rotz.value / 100;
};
